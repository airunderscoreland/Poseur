...
import poseur.events.edit.BringToBackHandler;
import poseur.events.edit.BringToFrontHandler;
...
public class PoseurGUI extends JFrame
{
    ...
    // NORTH PANEL - ALL CONTROLS GO HERE
    private JPanel northPanel;
    private JPanel northRightPanel;
    private JPanel northRightTopPanel;
    ...
    private JButton newAS;
    private JButton copyAS;
    private JButton removeAS;
    ...
    // VIEW SELECTION
    private JLabel viewSelectLabel;
    private JButton playAnimationViewButton;
    private JButton sequenceViewButton;
    ...
    private void constructGUIControls()
    {
        ...
        northRightTopPanel = new JPanel(new FlowLayout(FlowLayout.LEFT));
       ...
       // WE'LL BATCH LOAD THE IMAGES
        ...
        bringToBackButton = (JButton)initButton(BRING_TO_BACK_IMAGE_FILE,  editToolbar, tracker, idCounter++, JButton.class, null, BRING_TO_BACK_TOOLTIP);
     ...
     * @param mt Mediatracker for images
    ...
    private void initHandlers()
    {
        ...
        BringToBackHandler btbh = new BringToBackHandler();
        bringToBackButton.addActionListener(btbh);
        BringToFrontHandler btfh = new BringToFrontHandler();
        bringToFrontButton.addActionListener(btfh);
    ...
    private void setEnabledEditControls(boolean isEnabled)
    {
        ...
        bringToBackButton.setEnabled(isEnabled);
        bringToFrontButton.setEnabled(isEnabled);
